...
import {
  Search, Bell, HelpCircle, ChevronDown, Menu, X,
            ...
            {userOpen && (
              ...
              >
                <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-600">
                  <p className="text-sm text-slate-900 dark:text-white font-semibold" style={{ fontFamily: "'Sora', sans-serif" }}>Rajesh Kapoor</p>
                  <p className="text-xs text-slate-500">rajesh@propellect.com</p>
                </div>
